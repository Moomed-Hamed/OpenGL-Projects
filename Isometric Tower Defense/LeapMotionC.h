/* The leap motion SDK appears to be written according to modern industry standards.
   As a result, i have to do the developers jobs for them and rewrite their shitty
   header because apparently noone at leapmotion knows how to properly load a dll
